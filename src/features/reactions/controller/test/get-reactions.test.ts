import { reactionService } from './../../../../shared/services/db/reactions.services';
...
describe('GetReactions', () => {
  ...
  describe('reactions', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      await GetReactions.prototype.reactions(req, res);
  ...
  describe('singleReactionByUsername', () => {
    it('should send correct json response if reactions exist in cache', async () => {
      ...
      await GetReactions.prototype.singleReactionByUsername(req, res);
  ...
  describe('reactionsByUsername', () => {
    it('should send correct json response if reactions exist in database', async () => {
      ...
      await GetReactions.prototype.reactionsByUsername(req, res);
